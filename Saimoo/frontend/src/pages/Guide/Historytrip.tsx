...
const HistoryTrip = () => {
  ...
  const handleClone = (id) => {
    console.log('Clone trip:', id);
  };

  // ฟังก์ชันที่ใช้สำหรับนำทางไปยังหน้า "สร้างทริป"
  const handleCreateTrip = () => {
    navigate('/create-trip');  // เปลี่ยนเส้นทางไปยังหน้า "create-trip"
  };
    ...
    <div className="max-w-5xl mx-auto p-5 bg-gray-100 min-h-screen">
      ...
      <div className="text-center mb-6">
        <button
          ...
          onClick={() => {setIsDropdownOpen(false); navigate("/plan-trip")}} // ใช้ handleCreateTrip เพื่อนำทางไปหน้าใหม่
        >
          สร้างทริปใหม่
        </button>
      </div>
